...
namespace CleanCore.Extensions
{
    public static class VectorExtension
    {
        ...
        public static Vector3 ToVector3WithZlikeY(this Vector2 v, float y)
        {
        ...
        public static Vector3 Orthonormal(this Vector3 direction)
        {
            return Vector3.Cross(direction, Vector3.up).normalized;
        }

        public static Vector3 Orthonormal(this Vector3 direction, Vector3 upward)
        {
            return Vector3.Cross(direction, upward).normalized;
        }

        public static Vector3 Orthogonal(this Vector3 direction)
        {
